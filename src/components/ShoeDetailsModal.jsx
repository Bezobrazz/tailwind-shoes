    ...
    >
      ...
      <div className="flex max-h-[85vh] flex-col gap-6 px-8 pb-16 pt-20 md:px-10 md:py-12 overflow-y-auto">
        ...
        <div className="grid gap-3 text-sm text-gray-500 dark:text-gray-300">
          <p>
            Crafted for comfort and performance. Switch between looks with bold
            color blocking that mirrors our hero gradient palette.
          </p>
          <p>
            Responsive cushioning keeps you light on your feet, whether you are
            hitting the streets or elevating your daily fit.
          </p>
        </div>
      </div>
    </ModalShell>
